...
class LearnerUpdate:
    ...
    def __init__(
        ...
        variable_source: services.VariableSourceInterface,
    ...
    def warm_start(self):
        """Set parameters."""
        logging.info("Warm starting parameters.")
        params = self._variable_source.params
        params = distributed_utils.replicate_on_all_devices(params, self._local_devices)
