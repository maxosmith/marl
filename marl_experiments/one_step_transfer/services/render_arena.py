...
class RenderArena(base.ArenaInterface):
    ...
    def __init__(
        ...
        scenarios: Union[RenderScenario, Sequence[RenderScenario]],
        ...
        self._agents = agents
        self._bots = bots
        if isinstance(scenarios, RenderScenario):
            scenarios = [scenarios]
    ...
    def run_episode(self, game: worlds.Game, players: Mapping[_types.PlayerID, _types.Individual]) -> RenderResult:
        """Run one episode."""
        episode_length = 0
        ...
        return RenderResult(episode_length=episode_length, episode_return=episode_return, render=images)
