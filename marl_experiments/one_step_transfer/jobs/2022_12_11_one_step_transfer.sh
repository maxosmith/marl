...
sbatch --job-name=2022_12_11_one_step_transfer ../scripts/launch_gpu.sh python br_with_planning_main.py \
    --result_dir /scratch/wellman_root/wellman1/mxsmith/results/marl/one_step_transfer/2022_12_11_one_step_transfer/ \
