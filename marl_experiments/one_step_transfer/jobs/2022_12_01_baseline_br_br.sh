...
sbatch --job-name=2022_12_01_baseline_br_br ../scripts/launch.sh python br_main.py \
    --config.result_dir /scratch/wellman_root/wellman1/mxsmith/results/marl/one_step_transfer/2022_12_01_baseline_br_br/ \
