...
class ReferenceVariableSource(interfaces.VariableSource):
...
class VariableClient:
  ...
  def __init__(
      self,
      source: interfaces.VariableSource,
    ...
    self._source = source
    self._params: Sequence[types.Params] = None
  ...
  def _callback(self, params_list: List[types.Params]):
