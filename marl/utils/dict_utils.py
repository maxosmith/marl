...
def prefix_keys(x: Mapping[str, Any], prefix: str, delimiter: str = "/") -> Mapping[str, Any]:
    """Apply a prefix to all dictionary keys."""
    return key_apply(x, lambda k: f"{prefix}{delimiter}{k}")


def unprefix_keys(x: Mapping[str, Any], prefix: str, delimiter: str = "/") -> Mapping[str, Any]:
