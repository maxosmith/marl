...
class SequenceAdder(reverb_adder.ReverbAdder):
    ...
    def __init__(
        ...
        *,
        ...
        if end_of_episode_behavior and (pad_end_of_episode is not None or break_end_of_episode is not None):
            raise ValueError(
        ...
        if pad_end_of_episode is not None or break_end_of_episode is not None:
            ...
            raise ValueError(
                "end_of_episod_behavior must be an instance of " f"EndBehavior, received {end_of_episode_behavior}."
            )
    ...
    def _write_last(self):
        ...
        if self._end_of_episode_behavior is EndBehavior.CONTINUE:
            ...
            self._maybe_create_item(self._sequence_length - delta, end_of_episode=True, force=True)
    ...
    def signature(
        ...
        Args:
            environment_spec: A `worlds.EnvironmentSpec` whose fields are nested
